...
def get_args():
    ...
    # data args
    parser.add_argument("--feature_data_path", type=str, default="./data/sector_feature.npy")
    ...
    parser.add_argument('--resumedir', type=str, default="./checkpoints/log_04212326/best_model_04212326.pth")
